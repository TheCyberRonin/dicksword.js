...
class Client extends EventEmitter
{
  constructor(settings)
  {
    ...
    this._setEndpoints();
    Object.defineProperty(this.internals, '_reconnects', {value: 0, enumerable: false});
    if(settings.autorun)
    {
      this.connect();
    }
...
class Message
{
  ...
  react(emoji)
  {
    return new Promise((resolve, reject) =>
    {
      return this._client._APIcall('put', this._client.ENDPOINTS.USER_REACTIONS(this.channel_id, this.id, encodeURIComponent(new Emoji(emoji).toString()))).then((result) =>
      {
        resolve(result.body);
      }).catch(reject); 
    });
  ...
  cancelReact(emoji)
  {
    return new Promise((resolve, reject) =>
    {
      return this._client._APIcall('delete', this._client.ENDPOINTS.USER_REACTIONS(this.channel_id, this.id, encodeURIComponent(new Emoji(emoji).toString()))).then((result) =>
      {
        resolve(result.body);
      }).catch(reject); 
    });
  ...
  deleteReact(emoji, userID)
  {
    return new Promise((resolve, reject) =>
    {
      return this._client._APIcall('delete', this._client.ENDPOINTS.USER_REACTIONS(this.channel_id, this.id, encodeURIComponent(new Emoji(emoji).toString()), userID)).then((result) =>
      {
        resolve(result.body);
      }).catch(reject); 
    });
  ...
  deleteReacts()
  {
    return new Promise((resolve, reject) =>
    {
      return this._client._APIcall('delete', this._client.ENDPOINTS.MESSAGE_REACTIONS(this.channel_id, this.id)).then((result) =>
      {
        resolve(result);
      }).catch(reject); 
    });
  ...
  getReacts(emoji)
  {
    return new Promise((resolve, reject) =>
    {
      return this._client._APIcall('get', this._client.ENDPOINTS.MESSAGE_REACTIONS(this.channel_id, this.id, encodeURIComponent(new Emoji(emoji).toString()))).then((result) =>
      {
        resolve(result.body);
      }).catch(reject); 
    });
