...
const CLOSE_CODES = {
  4000: {description: 'Unknown error', explaination: 'We\'re not sure what went wrong, You should try reconnecting.'},
  4001: {description: 'Unknown opcode', explaination: 'You sent an invalid Gateway opcode. Don\'t do that!'},
  4002: {description: 'Unknown payload', explaination: 'You sent an invalid payload to us. Don\'t do that!'},
  4003: {description: 'Not authenticated', explaination: 'You sent us a payload prior to identifying.'},
  4004: {description: 'Authorization failed', explaination: 'The account token sent with your identify payload is incorrect.'},
  4005: {description: 'Already authorized', explaination: 'You sent more than one identify payload. Don\'t do that!'},
  ...
  4008: {description: 'Rate limited', explaination: 'Woah there buddy! You\'re sending payloads to us too quickly. Slow it down!'},
  ...
  4011: {description: 'Sharding required', explaination: 'Whoa! Your bot is popular. But the client would have crashed, we don\'t want that do we? To reconnect, you must shard your bot.'}
};
